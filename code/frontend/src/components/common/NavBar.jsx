            ...
            <Navbar.Collapse id="navbarScroll">
               <Nav className="me-auto my-2 my-lg-0" style={{ maxHeight: '100px' }} navbarScroll>
                  ...
                  {user.userData.type === 'Admin' && (
                     <NavLink onClick={() => handleOptionClick('courses')}>Courses</NavLink>
                  )}
                  ...
                  {/* Add Compiler link */}
                  <Nav.Link href="./public/compiler.html" target="_blank" rel="noopener noreferrer">
                     Compiler
                  </Nav.Link>
                  <Nav.Link href="./public/Resume.html" target="_blank" rel="noopener noreferrer">
                     Resume
                  </Nav.Link>
               </Nav>
               <Nav>
